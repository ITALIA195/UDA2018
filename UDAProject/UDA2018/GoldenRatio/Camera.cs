...
namespace UDA2018.GoldenRatio
{
    public class Camera
    {
        ...
        public float _time;
        private long _waitFor, _waitTime;
        ...
        public void Update()
        {
            ...
            if (Window.Stopwatch.ElapsedMilliseconds < _waitTime + _waitFor) return;
        ...
        public void CreateMatrix()
        {
            ...
            m4 = Matrix4.Mult(m4, Matrix4.CreateTranslation(-Position.X, -Position.Y, 0f));
            m4 = Matrix4.Mult(m4, Matrix4.CreateRotationZ(-Rotation));
            m4 = Matrix4.Mult(m4, Matrix4.CreateScale(Zoom, Zoom, 1f));
            _matrix = m4;
